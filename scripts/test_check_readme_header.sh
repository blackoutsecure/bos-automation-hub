...
[![Blackout Secure Gatekeeper](https://img.shields.io/github/actions/workflow/status/blackoutsecure/docker-x/bos-universal-gatekeeper-kicker.yml?style=flat-square&label=blackout%20secure%20gatekeeper&color=E7931D)](https://github.com/blackoutsecure/docker-x/actions/workflows/bos-universal-gatekeeper-kicker.yml)
