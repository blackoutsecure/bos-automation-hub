...
def main() -> None:
    ...
    assert "bos-code-scanning-kit@9d22481dd4695aee88bbdfb852c2abb2d42f93aa" in gate_workflow
    ...
    assert "bos-code-scanning-kit@9d22481dd4695aee88bbdfb852c2abb2d42f93aa" in standalone_scan_workflow
