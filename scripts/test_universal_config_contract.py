...
def main() -> None:
    ...
    assert "bos-code-scanning-kit@0732ebec8b130e898b0f2132ae74ec74c8ceab4b" in gate_workflow
    ...
    assert "bos-code-scanning-kit@0732ebec8b130e898b0f2132ae74ec74c8ceab4b" in standalone_scan_workflow
