...
def main() -> None:
    ...
    assert "bos-code-scanning-kit@e8d6e8660b0fc93e0473ad0b728eb5c4bfd54a01" in gate_workflow
    ...
    assert "bos-code-scanning-kit@e8d6e8660b0fc93e0473ad0b728eb5c4bfd54a01" in standalone_scan_workflow
