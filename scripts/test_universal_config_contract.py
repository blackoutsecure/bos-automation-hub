...
def main() -> None:
    ...
    assert "bos-code-scanning-kit@d8f58b2f908f98701f992d9473aa7a4bb0f634a2" in gate_workflow
    ...
    assert "bos-code-scanning-kit@d8f58b2f908f98701f992d9473aa7a4bb0f634a2" in standalone_scan_workflow
