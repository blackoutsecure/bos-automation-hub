...
def main() -> None:
    ...
    assert "bos-code-scanning-kit@ebc4397baea0cfcc182ca8ade2b91b73ccd0c071" in gate_workflow
    ...
    assert "bos-code-scanning-kit@ebc4397baea0cfcc182ca8ade2b91b73ccd0c071" in standalone_scan_workflow
