...
def main() -> None:
    ...
    assert "bos-code-scanning-kit@0fdea4e7bdcb9a04b1a2e525393e4cb00cf9feff" in gate_workflow
    ...
    assert "bos-code-scanning-kit@0fdea4e7bdcb9a04b1a2e525393e4cb00cf9feff" in standalone_scan_workflow
