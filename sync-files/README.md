...
of `.github/workflow-configs/bos-universal-config.json`. The global policy enables
...
This repository's own sync wrappers use `.github/workflow-configs/bos-universal-config.json` as
...
- [`bos-universal-launchpad-kicker.yml`](workflows/bos-universal-launchpad-kicker.yml)
  is the managed release/deploy caller. It reads `.github/workflow-configs/bos-universal-config.json`
...
workflow per repository; `.github/workflow-configs/bos-universal-config.json` controls sync behavior
